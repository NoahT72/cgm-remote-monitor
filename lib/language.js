...
function init() {
  ...
  var translations = {
    ...
    ,'Loading treatments data of' : {   
      ...
      ,id: 'Loading data perawatan dari'
      }
    ,'Processing data of' : {   
      cs: 'Zpracovávám data'
...
// ported reporting
    ...
    ,'There is not sufficient data to run this report. Select more days.' : {   
      ...
      ,id : 'Tak ada data yg memadai untuk menjalankan laporan ini. Pilih hari lagi.'
	  }
// food editor
    ,'Using stored API secret hash' : {   
      ...
      ,id: 'Menggunakan API simpanan rahasia hash'
      }
    ,'No API secret hash stored yet. You need to enter API secret.' : {   
      ...
      ,id: 'Tak ada API rahasia hash tersimpan. Anda harus memasukkan API rahasia'
      }
    ,'Database loaded' : {   
      cs: 'Databáze načtena'
    ...
    ,'Hide after use' : {   
      ...
      ,id: 'Menyembunyikan setelah digunakan'
      }
    ,'Your API secret must be at least 12 characters long' : {   
      ...
      ,id: 'API Rahasia Anda harus minimal 12 karakter'
      }
    ,'Bad API secret' : {   
      cs: 'Chybné API heslo'
